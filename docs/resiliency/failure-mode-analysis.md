...
- <span data-ttu-id="0b339-132">予期されないシャットダウン</span><span class="sxs-lookup"><span data-stu-id="0b339-132">Unexpected shutdown</span></span>
  ...
  - <span data-ttu-id="0b339-133">アプリがクラッシュしました。</span><span class="sxs-lookup"><span data-stu-id="0b339-133">The app crashes.</span></span>
...
<span data-ttu-id="0b339-152">**復旧:**</span><span class="sxs-lookup"><span data-stu-id="0b339-152">**Recovery:**</span></span>
...
<span data-ttu-id="0b339-174">**復旧:**</span><span class="sxs-lookup"><span data-stu-id="0b339-174">**Recovery:**</span></span>
...
<span data-ttu-id="0b339-192">**検出**。</span><span class="sxs-lookup"><span data-stu-id="0b339-192">**Detection**.</span></span> <span data-ttu-id="0b339-193">`Microsoft.Rest.Azure.CloudException` エラーをキャッチします。</span><span class="sxs-lookup"><span data-stu-id="0b339-193">Catch `Microsoft.Rest.Azure.CloudException` errors.</span></span>
...
- <span data-ttu-id="0b339-232">クライアントが Cosmos DB によってスロットルされると、HTTP 429 エラーが返されます。</span><span class="sxs-lookup"><span data-stu-id="0b339-232">If Cosmos DB throttles the client, it returns an HTTP 429 error.</span></span> <span data-ttu-id="0b339-233">`DocumentClientException` で状態コードを確認します。</span><span class="sxs-lookup"><span data-stu-id="0b339-233">Check the status code in the `DocumentClientException`.</span></span> <span data-ttu-id="0b339-234">エラー 429 が繰り返し発生する場合は、コレクションのスループットの値を増やすことを検討してください。</span><span class="sxs-lookup"><span data-stu-id="0b339-234">If you are getting error 429 consistently, consider increasing the throughput value of the collection.</span></span>
...
<span data-ttu-id="0b339-273">**診断**</span><span class="sxs-lookup"><span data-stu-id="0b339-273">**Diagnostics**.</span></span> <span data-ttu-id="0b339-274">Elasticsearch 用の監視ツールを使用するか、クライアント側でペイロードを含むすべてのエラーをログに記録することができます。</span><span class="sxs-lookup"><span data-stu-id="0b339-274">You can use monitoring tools for Elasticsearch, or log all errors on the client side with the payload.</span></span> <span data-ttu-id="0b339-275">「[Running Elasticsearch on Azure][elasticsearch-azure]」(Azure で Elasticsearch を実行する) の「Monitoring」(監視) セクションを参照してください。</span><span class="sxs-lookup"><span data-stu-id="0b339-275">See the 'Monitoring' section in [Running Elasticsearch on Azure][elasticsearch-azure].</span></span>
...
<span data-ttu-id="0b339-289">**検出**。</span><span class="sxs-lookup"><span data-stu-id="0b339-289">**Detection**.</span></span> <span data-ttu-id="0b339-290">*N* 回再試行を試みた後も、書き込み操作がまだ失敗します。</span><span class="sxs-lookup"><span data-stu-id="0b339-290">After *N* retry attempts, the write operation still fails.</span></span>
...
## <a name="redis-cache"></a><span data-ttu-id="0b339-308">Redis Cache</span><span class="sxs-lookup"><span data-stu-id="0b339-308">Redis Cache</span></span>
...
<span data-ttu-id="0b339-325">**診断**</span><span class="sxs-lookup"><span data-stu-id="0b339-325">**Diagnostics**.</span></span> <span data-ttu-id="0b339-326">[Redis Cache の診断][redis-monitor]を使用します。</span><span class="sxs-lookup"><span data-stu-id="0b339-326">Use [Redis Cache diagnostics][redis-monitor].</span></span>
...
- <span data-ttu-id="0b339-342">操作をやり直してください。</span><span class="sxs-lookup"><span data-stu-id="0b339-342">Retry the operation.</span></span>
...
## <a name="service-bus-messaging"></a><span data-ttu-id="0b339-361">Service Bus メッセージング</span><span class="sxs-lookup"><span data-stu-id="0b339-361">Service Bus Messaging</span></span>
...
<span data-ttu-id="0b339-381">詳細については、「[Service Bus メッセージングの例外][sb-messaging-exceptions]」を参照してください。</span><span class="sxs-lookup"><span data-stu-id="0b339-381">For more information, see [Service Bus messaging exceptions][sb-messaging-exceptions].</span></span>
...
<span data-ttu-id="0b339-422">**検出**。</span><span class="sxs-lookup"><span data-stu-id="0b339-422">**Detection**.</span></span> <span data-ttu-id="0b339-423">アプリケーション固有です。</span><span class="sxs-lookup"><span data-stu-id="0b339-423">Application specific.</span></span> <span data-ttu-id="0b339-424">たとえば、メッセージに無効なデータが含まれる場合や、ビジネス ロジックが何らかの理由で失敗する場合があります。</span><span class="sxs-lookup"><span data-stu-id="0b339-424">For example, the message contains invalid data, or the business logic fails for some reason.</span></span>
...
- <span data-ttu-id="0b339-442">プロキシをもう一度検索し (`ServiceProxy` または `ActorProxy`)、サービス/アクター メソッドを再度呼び出します。</span><span class="sxs-lookup"><span data-stu-id="0b339-442">Locate a proxy again (`ServiceProxy` or `ActorProxy`) and call the service/actor method again.</span></span>
...
<span data-ttu-id="0b339-462">**検出**。</span><span class="sxs-lookup"><span data-stu-id="0b339-462">**Detection**.</span></span> <span data-ttu-id="0b339-463">クライアントは、書き込み時にエラーを受け取ります。</span><span class="sxs-lookup"><span data-stu-id="0b339-463">The client receives errors when writing.</span></span>
...
<span data-ttu-id="0b339-485">**診断**</span><span class="sxs-lookup"><span data-stu-id="0b339-485">**Diagnostics**.</span></span> <span data-ttu-id="0b339-486">[ストレージ メトリック][storage-metrics]を使用します。</span><span class="sxs-lookup"><span data-stu-id="0b339-486">Use [storage metrics][storage-metrics].</span></span>
...
- <span data-ttu-id="0b339-492">ロード バランサーの背後の可用性セットに、少なくとも 2 つのバックエンド VM をデプロイします。</span><span class="sxs-lookup"><span data-stu-id="0b339-492">Deploy at least two backend VMs in an availability set, behind a load balancer.</span></span>
- <span data-ttu-id="0b339-493">接続エラーが一時的な場合は、TCP が正常にメッセージの送信を再試行することがあります。</span><span class="sxs-lookup"><span data-stu-id="0b339-493">If the connection error is transient, sometimes TCP will successfully retry sending the message.</span></span>
- <span data-ttu-id="0b339-494">アプリケーションに再試行ポリシーを実装します。</span><span class="sxs-lookup"><span data-stu-id="0b339-494">Implement a retry policy in the application.</span></span>
- <span data-ttu-id="0b339-495">永続的なエラーまたは一時的でないエラーの場合は、[サーキット ブレーカー][circuit-breaker] パターンを実装します。</span><span class="sxs-lookup"><span data-stu-id="0b339-495">For persistent or non-transient errors, implement the [Circuit Breaker][circuit-breaker] pattern.</span></span>
- <span data-ttu-id="0b339-496">呼び出し元の VM がネットワーク送信制限を超えた場合は、送信キューがいっぱいになります。</span><span class="sxs-lookup"><span data-stu-id="0b339-496">If the calling VM exceeds its network egress limit, the outbound queue will fill up.</span></span> <span data-ttu-id="0b339-497">送信キューが常にいっぱいになっている場合は、スケールアウトを検討してください。</span><span class="sxs-lookup"><span data-stu-id="0b339-497">If the outbound queue is consistently full, consider scaling out.</span></span>

<span data-ttu-id="0b339-498">**診断**</span><span class="sxs-lookup"><span data-stu-id="0b339-498">**Diagnostics**.</span></span> <span data-ttu-id="0b339-499">サービスの境界でイベントのログを記録します。</span><span class="sxs-lookup"><span data-stu-id="0b339-499">Log events at service boundaries.</span></span>

### <a name="vm-instance-becomes-unavailable-or-unhealthy"></a><span data-ttu-id="0b339-500">VM インスタンスが使用不可または異常になる。</span><span class="sxs-lookup"><span data-stu-id="0b339-500">VM instance becomes unavailable or unhealthy.</span></span>

<span data-ttu-id="0b339-501">**検出**。</span><span class="sxs-lookup"><span data-stu-id="0b339-501">**Detection**.</span></span> <span data-ttu-id="0b339-502">VM インスタンスが正常かどうかを通知する Load Balancer [正常性プローブ][lb-probe]を構成します。</span><span class="sxs-lookup"><span data-stu-id="0b339-502">Configure a Load Balancer [health probe][lb-probe] that signals whether the VM instance is healthy.</span></span> <span data-ttu-id="0b339-503">プローブは、重要な機能が正しく応答しているかどうかを確認する必要があります。</span><span class="sxs-lookup"><span data-stu-id="0b339-503">The probe should check whether critical functions are responding correctly.</span></span>

<span data-ttu-id="0b339-504">**復旧**。</span><span class="sxs-lookup"><span data-stu-id="0b339-504">**Recovery**.</span></span> <span data-ttu-id="0b339-505">アプリケーション層ごとに、複数の VM インスタンスを同じ可用性セットに格納し、VM の前にロード バランサーを配置します。</span><span class="sxs-lookup"><span data-stu-id="0b339-505">For each application tier, put multiple VM instances into the same availability set, and place a load balancer in front of the VMs.</span></span> <span data-ttu-id="0b339-506">正常性プローブが失敗した場合、Load Balancer は異常なインスタンスへの新しい接続の送信を停止します。</span><span class="sxs-lookup"><span data-stu-id="0b339-506">If the health probe fails, the Load Balancer stops sending new connections to the unhealthy instance.</span></span>

<span data-ttu-id="0b339-507">**診断**</span><span class="sxs-lookup"><span data-stu-id="0b339-507">**Diagnostics**.</span></span> <span data-ttu-id="0b339-508">- Load Balancer の [ログ分析][lb-monitor]を使用します。</span><span class="sxs-lookup"><span data-stu-id="0b339-508">- Use Load Balancer [log analytics][lb-monitor].</span></span>

- <span data-ttu-id="0b339-509">すべての正常性監視エンドポイントを監視するように、監視システムを構成します。</span><span class="sxs-lookup"><span data-stu-id="0b339-509">Configure your monitoring system to monitor all of the health monitoring endpoints.</span></span>

### <a name="operator-accidentally-shuts-down-a-vm"></a><span data-ttu-id="0b339-510">オペレーターが誤って VM をシャットダウンした。</span><span class="sxs-lookup"><span data-stu-id="0b339-510">Operator accidentally shuts down a VM.</span></span>

<span data-ttu-id="0b339-511">**検出**。</span><span class="sxs-lookup"><span data-stu-id="0b339-511">**Detection**.</span></span> <span data-ttu-id="0b339-512">該当なし</span><span class="sxs-lookup"><span data-stu-id="0b339-512">N/A</span></span>

<span data-ttu-id="0b339-513">**復旧**。</span><span class="sxs-lookup"><span data-stu-id="0b339-513">**Recovery**.</span></span> <span data-ttu-id="0b339-514">リソース ロックを `ReadOnly` レベルに設定します。</span><span class="sxs-lookup"><span data-stu-id="0b339-514">Set a resource lock with `ReadOnly` level.</span></span> <span data-ttu-id="0b339-515">詳細については、[Azure Resource Manager でのリソースのロック][rm-locks]に関するページを参照してください。</span><span class="sxs-lookup"><span data-stu-id="0b339-515">See [Lock resources with Azure Resource Manager][rm-locks].</span></span>

<span data-ttu-id="0b339-516">**診断**</span><span class="sxs-lookup"><span data-stu-id="0b339-516">**Diagnostics**.</span></span> <span data-ttu-id="0b339-517">[Azure Activity Logs][azure-activity-logs] を使用します。</span><span class="sxs-lookup"><span data-stu-id="0b339-517">Use [Azure Activity Logs][azure-activity-logs].</span></span>

## <a name="webjobs"></a><span data-ttu-id="0b339-518">WebJobs</span><span class="sxs-lookup"><span data-stu-id="0b339-518">WebJobs</span></span>

### <a name="continuous-job-stops-running-when-the-scm-host-is-idle"></a><span data-ttu-id="0b339-519">SCM ホストがアイドル状態のとき、継続的なジョブが実行を停止する。</span><span class="sxs-lookup"><span data-stu-id="0b339-519">Continuous job stops running when the SCM host is idle.</span></span>

<span data-ttu-id="0b339-520">**検出**。</span><span class="sxs-lookup"><span data-stu-id="0b339-520">**Detection**.</span></span> <span data-ttu-id="0b339-521">WebJob 関数にキャンセル トークンを渡します。</span><span class="sxs-lookup"><span data-stu-id="0b339-521">Pass a cancellation token to the WebJob function.</span></span> <span data-ttu-id="0b339-522">詳細については、[グレースフル シャットダウン][web-jobs-shutdown]に関するページを参照してください。</span><span class="sxs-lookup"><span data-stu-id="0b339-522">For more information, see [Graceful shutdown][web-jobs-shutdown].</span></span>

<span data-ttu-id="0b339-523">**復旧**。</span><span class="sxs-lookup"><span data-stu-id="0b339-523">**Recovery**.</span></span> <span data-ttu-id="0b339-524">Web アプリで `Always On` の設定を有効にします。</span><span class="sxs-lookup"><span data-stu-id="0b339-524">Enable the `Always On` setting in the web app.</span></span> <span data-ttu-id="0b339-525">詳細については、[WebJobs でのバックグラウンド タスクの実行][web-jobs]に関するページを参照してください。</span><span class="sxs-lookup"><span data-stu-id="0b339-525">For more information, see [Run Background tasks with WebJobs][web-jobs].</span></span>

## <a name="application-design"></a><span data-ttu-id="0b339-526">アプリケーションの設計</span><span class="sxs-lookup"><span data-stu-id="0b339-526">Application design</span></span>

### <a name="application-cant-handle-a-spike-in-incoming-requests"></a><span data-ttu-id="0b339-527">アプリケーションが受信要求のスパイクを処理できない。</span><span class="sxs-lookup"><span data-stu-id="0b339-527">Application can't handle a spike in incoming requests.</span></span>

<span data-ttu-id="0b339-528">**検出**。</span><span class="sxs-lookup"><span data-stu-id="0b339-528">**Detection**.</span></span> <span data-ttu-id="0b339-529">アプリケーションによって異なります。</span><span class="sxs-lookup"><span data-stu-id="0b339-529">Depends on the application.</span></span> <span data-ttu-id="0b339-530">一般的な現象:</span><span class="sxs-lookup"><span data-stu-id="0b339-530">Typical symptoms:</span></span>

- <span data-ttu-id="0b339-531">Web サイトが HTTP 5xx エラー コードを返し始めます。</span><span class="sxs-lookup"><span data-stu-id="0b339-531">The website starts returning HTTP 5xx error codes.</span></span>
- <span data-ttu-id="0b339-532">データベースやストレージなどの依存サービスが、要求の調整を始めます。</span><span class="sxs-lookup"><span data-stu-id="0b339-532">Dependent services, such as database or storage, start to throttle requests.</span></span> <span data-ttu-id="0b339-533">サービスに応じて、HTTP 429 (要求数が多すぎる) などの HTTP エラーを探します。</span><span class="sxs-lookup"><span data-stu-id="0b339-533">Look for HTTP errors such as HTTP 429 (Too Many Requests), depending on the service.</span></span>
- <span data-ttu-id="0b339-534">HTTP キューが長くなりすぎます。</span><span class="sxs-lookup"><span data-stu-id="0b339-534">HTTP queue length grows.</span></span>

<span data-ttu-id="0b339-535">**復旧:**</span><span class="sxs-lookup"><span data-stu-id="0b339-535">**Recovery:**</span></span>

- <span data-ttu-id="0b339-536">増加した負荷を処理するためにスケールアウトします。</span><span class="sxs-lookup"><span data-stu-id="0b339-536">Scale out to handle increased load.</span></span>
- <span data-ttu-id="0b339-537">エラーを軽減し、障害が連鎖してアプリケーション全体が停止するのを防ぎます。</span><span class="sxs-lookup"><span data-stu-id="0b339-537">Mitigate failures to avoid having cascading failures disrupt the entire application.</span></span> <span data-ttu-id="0b339-538">次のような軽減戦略があります。</span><span class="sxs-lookup"><span data-stu-id="0b339-538">Mitigation strategies include:</span></span>

  - <span data-ttu-id="0b339-539">[調整パターン][throttling-pattern]を実装して、バックエンド システムの過負荷を回避します。</span><span class="sxs-lookup"><span data-stu-id="0b339-539">Implement the [Throttling pattern][throttling-pattern] to avoid overwhelming backend systems.</span></span>
  - <span data-ttu-id="0b339-540">[キュー ベースの負荷の平準化][queue-based-load-leveling]を使用して、要求をバッファリングし、適切な速度で処理します。</span><span class="sxs-lookup"><span data-stu-id="0b339-540">Use [queue-based load leveling][queue-based-load-leveling] to buffer requests and process them at an appropriate pace.</span></span>
  - <span data-ttu-id="0b339-541">特定のクライアントを優先します。</span><span class="sxs-lookup"><span data-stu-id="0b339-541">Prioritize certain clients.</span></span> <span data-ttu-id="0b339-542">たとえば、アプリケーションに無料レベルと有料レベルがある場合、無料レベルの顧客を調整し、有料レベルの顧客は調整しないようにします。</span><span class="sxs-lookup"><span data-stu-id="0b339-542">For example, if the application has free and paid tiers, throttle customers on the free tier, but not paid customers.</span></span> <span data-ttu-id="0b339-543">「[Priority Queue パターン][priority-queue-pattern]」を参照してください。</span><span class="sxs-lookup"><span data-stu-id="0b339-543">See [Priority queue pattern][priority-queue-pattern].</span></span>

<span data-ttu-id="0b339-544">**診断**</span><span class="sxs-lookup"><span data-stu-id="0b339-544">**Diagnostics**.</span></span> <span data-ttu-id="0b339-545">[App Service 診断ログ][app-service-logging]を使用します。</span><span class="sxs-lookup"><span data-stu-id="0b339-545">Use [App Service diagnostic logging][app-service-logging].</span></span> <span data-ttu-id="0b339-546">[Azure Log Analytics][azure-log-analytics]、[Application Insights][app-insights]、[New Relic][new-relic] などのサービスを使用して、診断ログを理解します。</span><span class="sxs-lookup"><span data-stu-id="0b339-546">Use a service such as [Azure Log Analytics][azure-log-analytics], [Application Insights][app-insights], or [New Relic][new-relic] to help understand the diagnostic logs.</span></span>

### <a name="one-of-the-operations-in-a-workflow-or-distributed-transaction-fails"></a><span data-ttu-id="0b339-547">ワークフローまたは分散トランザクションの操作の 1 つが失敗する。</span><span class="sxs-lookup"><span data-stu-id="0b339-547">One of the operations in a workflow or distributed transaction fails.</span></span>

<span data-ttu-id="0b339-548">**検出**。</span><span class="sxs-lookup"><span data-stu-id="0b339-548">**Detection**.</span></span> <span data-ttu-id="0b339-549">*N* 回再試行した後で、まだ失敗します。</span><span class="sxs-lookup"><span data-stu-id="0b339-549">After *N* retry attempts, it still fails.</span></span>

<span data-ttu-id="0b339-550">**復旧:**</span><span class="sxs-lookup"><span data-stu-id="0b339-550">**Recovery:**</span></span>

- <span data-ttu-id="0b339-551">軽減計画としては、[スケジューラー エージェント スーパーバイザー][scheduler-agent-supervisor] パターンを実装して、ワークフロー全体を管理します。</span><span class="sxs-lookup"><span data-stu-id="0b339-551">As a mitigation plan, implement the [Scheduler Agent Supervisor][scheduler-agent-supervisor] pattern to manage the entire workflow.</span></span>
- <span data-ttu-id="0b339-552">タイムアウト時に再試行しないでください。</span><span class="sxs-lookup"><span data-stu-id="0b339-552">Don't retry on timeouts.</span></span> <span data-ttu-id="0b339-553">このエラーの場合、成功する確率は高くありません。</span><span class="sxs-lookup"><span data-stu-id="0b339-553">There is a low success rate for this error.</span></span>
- <span data-ttu-id="0b339-554">後で再試行するため、キューに作業を格納します。</span><span class="sxs-lookup"><span data-stu-id="0b339-554">Queue work, in order to retry later.</span></span>

<span data-ttu-id="0b339-555">**診断**</span><span class="sxs-lookup"><span data-stu-id="0b339-555">**Diagnostics**.</span></span> <span data-ttu-id="0b339-556">補正アクションなど、(成功と失敗を含む) すべての操作をログに記録します。</span><span class="sxs-lookup"><span data-stu-id="0b339-556">Log all operations (successful and failed), including compensating actions.</span></span> <span data-ttu-id="0b339-557">相関 ID を使用して、同じトランザクション内のすべての操作を追跡できるようにします。</span><span class="sxs-lookup"><span data-stu-id="0b339-557">Use correlation IDs, so that you can track all operations within the same transaction.</span></span>

### <a name="a-call-to-a-remote-service-fails"></a><span data-ttu-id="0b339-558">リモート サービスの呼び出しが失敗する。</span><span class="sxs-lookup"><span data-stu-id="0b339-558">A call to a remote service fails.</span></span>

<span data-ttu-id="0b339-559">**検出**。</span><span class="sxs-lookup"><span data-stu-id="0b339-559">**Detection**.</span></span> <span data-ttu-id="0b339-560">HTTP エラー コード。</span><span class="sxs-lookup"><span data-stu-id="0b339-560">HTTP error code.</span></span>

<span data-ttu-id="0b339-561">**復旧:**</span><span class="sxs-lookup"><span data-stu-id="0b339-561">**Recovery:**</span></span>

1. <span data-ttu-id="0b339-562">一時的な障害の場合は再試行します。</span><span class="sxs-lookup"><span data-stu-id="0b339-562">Retry on transient failures.</span></span>
2. <span data-ttu-id="0b339-563">*N* 回試みても呼び出しが失敗する場合は、フォールバック アクションを実行します。</span><span class="sxs-lookup"><span data-stu-id="0b339-563">If the call fails after *N* attempts, take a fallback action.</span></span> <span data-ttu-id="0b339-564">(アプリケーション固有。)</span><span class="sxs-lookup"><span data-stu-id="0b339-564">(Application specific.)</span></span>
3. <span data-ttu-id="0b339-565">[サーキット ブレーカー パターン][circuit-breaker]を実装し、障害の連鎖を回避します。</span><span class="sxs-lookup"><span data-stu-id="0b339-565">Implement the [Circuit Breaker pattern][circuit-breaker] to avoid cascading failures.</span></span>

<span data-ttu-id="0b339-566">**診断**</span><span class="sxs-lookup"><span data-stu-id="0b339-566">**Diagnostics**.</span></span> <span data-ttu-id="0b339-567">リモート呼び出しのすべてのエラーをログに記録します。</span><span class="sxs-lookup"><span data-stu-id="0b339-567">Log all remote call failures.</span></span>

## <a name="next-steps"></a><span data-ttu-id="0b339-568">次の手順</span><span class="sxs-lookup"><span data-stu-id="0b339-568">Next steps</span></span>

<span data-ttu-id="0b339-569">FMA プロセスについては、「[Resilience by design for cloud services][resilience-by-design-pdf]」(クラウド サービス向けの設計による回復力) を参照してください (PDF のダウンロード)。</span><span class="sxs-lookup"><span data-stu-id="0b339-569">For more information about the FMA process, see [Resilience by design for cloud services][resilience-by-design-pdf] (PDF download).</span></span>
